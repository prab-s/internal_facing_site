...
declare module '$env/static/private' {
	...
	export const WORDPRESS_DB_ROOT_PASSWORD: string;
	...
	export const WORDPRESS_DB_PASSWORD: string;
	...
	export const WORDPRESS_PORT: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		WORDPRESS_DB_ROOT_PASSWORD: string;
